...
set(stdout_log "E:/Blackflame/civetweb/build/third_party/src/check-unit-test-framework-stamp/check-unit-test-framework-build-out.log")
set(stderr_log "E:/Blackflame/civetweb/build/third_party/src/check-unit-test-framework-stamp/check-unit-test-framework-build-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  E:/Blackflame/civetweb/build/third_party/src/check-unit-test-framework-stamp/check-unit-test-framework-build-*.log")
  endif()
  ...
  if(NOT "Visual Studio 17 2022" MATCHES "Ninja")
    set(msg "check-unit-test-framework build command succeeded.  See also E:/Blackflame/civetweb/build/third_party/src/check-unit-test-framework-stamp/check-unit-test-framework-build-*.log")
    message(STATUS "${msg}")
  endif()
endif()
